...
_common_tfm_builder_cfg = {
    ...
    "post_build": {"arm/corstone1000": ("dd conv=notrunc bs=1 if=%(ci_build_root_dir)s/spe/bin/bl1_1.bin of=%(ci_build_root_dir)s/spe/bin/bl1.bin seek=0;"
                                        "dd conv=notrunc bs=1 if=%(ci_build_root_dir)s/spe/bin/bl1_provisioning_bundle.bin of=%(ci_build_root_dir)s/spe/bin/bl1.bin seek=59392;"
                    ...
                    "arm/rse/tc/tc3": ("if [ -f \"%(ci_build_root_dir)s/spe/bin/rse_bl1_tests.bin\" ]; then "
                                   ...
                                   "if [ -f \"%(ci_build_root_dir)s/spe/bin/tfm_s_sic_tables_signed.bin\" ]; then "
                                   "./fiptool update "
                                   ...
                                   "./fiptool update "
                                   "--align 8192 --rse-bl2 %(ci_build_root_dir)s/spe/bin/bl2_signed.bin "
                                   "--align 8192 --rse-ns %(ci_build_root_dir)s/nspe/bin/tfm_ns_signed.bin "
                                   "--align 8192 --rse-s %(ci_build_root_dir)s/spe/bin/tfm_s_signed.bin "
                                   "--out %(ci_build_root_dir)s/spe/bin/host_flash.bin "
                                   "fip.bin; "
                                   "fi;"),
                   ...
                   "nxp/frdmmcxn947": ("echo 'frdmmcxn947 bo.ard post process\n';"
                                           ...
                                           "rm -f flash.jlink; "
                                           "echo r >> flash.jlink; "
                                           "echo unlock LPC5460x >> flash.jlink; "
                                           "echo exec EnableEraseAllFlashBanks >> flash.jlink; "
...
config_all_plat = {
                ...
                "valid": [
                    ...
                    #("nordic_nrf/nrf5340dk_nrf5340_cpuapp", "GCC_14_3", "1",
                    # "OFF", "OFF", "Release", True, "", "NSOFF"),
...
config_rse_tc3 = {"seed_params": {
                ...
                "invalid": _common_tfm_invalid_configs + [
                    ...
                    ("arm/rse/tc/tc3", "GCC_14_3", "*", "RegBL2, RegS, RegNS", "*",
                     "Debug", True, "*", "*"),
                ]
                }
...
config_rse_tc4 = {"seed_params": {
                ...
                "invalid": _common_tfm_invalid_configs + [
                    # BL2 is too large for RSE in Debug builds with tests
                    ("arm/rse/tc/tc4", "GCC_14_3", "*", "RegBL2, RegS, RegNS", "*",
                     "Debug", True, "*", "*"),
                ],
                "valid": [
...
_builtin_configs = {
                    ...
                    "nxp_frdmmcxn947" : config_frdmmcxn947,
